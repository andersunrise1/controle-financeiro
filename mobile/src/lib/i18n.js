// Mirrors frontend/lib/i18n.ts exactly — same keys, same 3 languages,
// same category/error translation tables.
const pt = {
  logout: "Sair",
  greeting: "Olá,",
  ...
  categoryChartEmpty: "Adicione transações para visualizar os gastos por categoria.",
  categoryChartFooter:
...
const en = {
  ...
  categoryChartFooter:
    "Each category gets its own color — the more categories you use, the more colors appear in the chart.",
...
const es = {
  ...
  categoryChartFooter:
    "Cada categoría tiene su propio color — cuantas más categorías uses, más colores aparecen en el gráfico.",
...
const categoryTranslations = {
  pt: {
    Salário: "Salário", Mercado: "Mercado", Moradia: "Moradia",
    Transporte: "Transporte", Lazer: "Lazer", Saúde: "Saúde", Outros: "Outros",
  },
  en: {
    Salário: "Salary", Mercado: "Groceries", Moradia: "Housing",
    Transporte: "Transportation", Lazer: "Leisure", Saúde: "Health", Outros: "Other",
  },
  es: {
    Salário: "Salario", Mercado: "Mercado", Moradia: "Vivienda",
    Transporte: "Transporte", Lazer: "Ocio", Saúde: "Salud", Outros: "Otros",
  },
};
...
// arrives as this exact Portuguese text. This table maps that canonical
// Portuguese string to the other locales; an unmapped string falls back
