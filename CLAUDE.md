...
2. **Núcleo financeiro** — ~2-3 dias, escopo ampliado. Saldo, Nova Transação (com recorrência semanal/mensal/anual), Histórico com busca/filtro, categorias, **Feedback** e **Admin** (gate por e-mail).
